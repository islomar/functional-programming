...
var _user$project$Test$initialModel = {name: 'ELM 101', counter: 3};
var _user$project$Test$randomNumber = A2(_elm_lang$core$Random$int, 0, 100);
var _user$project$Test$Model = F2(
	function (a, b) {
		return {name: a, counter: b};
	});
var _user$project$Test$Update = function (a) {
		...
		switch (_p0.ctor) {
			...
			case 'GetRandom':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$core$Random$generate, _user$project$Test$Update, _user$project$Test$randomNumber)
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _user$project$Test$GetRandom = {ctor: 'GetRandom'};
var _user$project$Test$Down = {ctor: 'Down'};
var _user$project$Test$Up = {ctor: 'Up'};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Test$Up)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Test$Down)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Test$GetRandom)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Test$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$Test$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
			view: _user$project$Test$view,
			update: _user$project$Test$update,
